...
- Grouped by place and date, 14,553 distinct floods are returned
...
## From 32,292 accounts to one disruption tree

<svg viewBox="0 0 1560 240" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Three real cause and effect arrows from the disruption graph with their support counts" style="width:100%;max-width:1240px;height:auto;display:block;margin:0 auto;">
  <g fill="#e3edf9" stroke="#7ba3d4" stroke-width="1.5">
    <rect x="10"   y="30" width="215" height="92" rx="6"/>
    <rect x="290"  y="30" width="215" height="92" rx="6"/>
    <rect x="540"  y="30" width="215" height="92" rx="6"/>
    <rect x="820"  y="30" width="215" height="92" rx="6"/>
    <rect x="1070" y="30" width="215" height="92" rx="6"/>
    <rect x="1335" y="30" width="215" height="92" rx="6"/>
  </g>
  <g stroke="#8a97a6" stroke-width="2" fill="none">
    <path d="M227 76 L286 76"/>
    <path d="M757 76 L816 76"/>
    <path d="M1287 76 L1331 76"/>
  </g>
  <g fill="#8a97a6">
    <path d="M288 76 L276 70 L276 82 Z"/>
    <path d="M818 76 L806 70 L806 82 Z"/>
    <path d="M1333 76 L1321 70 L1321 82 Z"/>
  </g>
  <g font-family="system-ui,-apple-system,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif" font-size="20" fill="#1f6db4" text-anchor="middle">
    <text x="117" y="66">Flooded roads cut</text>
    <text x="117" y="92">off access to care</text>
    <text x="397" y="66">People unable to</text>
    <text x="397" y="92">reach facilities</text>
    <text x="647" y="66">Electricity</text>
    <text x="647" y="92">disrupted</text>
    <text x="927" y="66">Water and</text>
    <text x="927" y="92">sanitation fail</text>
    <text x="1177" y="66">Access cut off</text>
    <text x="1177" y="92">by flooding</text>
    <text x="1442" y="58">Disruption reaches</text>
    <text x="1442" y="80">facilities outside</text>
    <text x="1442" y="102">the flood footprint</text>
  </g>
  <g font-family="system-ui,-apple-system,'Segoe UI',Roboto,'Helvetica Neue',Arial,sans-serif" font-size="19" fill="#33495d" text-anchor="middle">
    <text x="257" y="165">seen in 265 floods,</text>
    <text x="257" y="188">340 documents</text>
    <text x="787" y="165">seen in 80 floods,</text>
    <text x="787" y="188">89 documents</text>
    <text x="1310" y="165">seen in 69 floods,</text>
    <text x="1310" y="188">84 documents</text>
  </g>
</svg>

- Accounts describing the same step are merged into 22,138 unique steps, joined by 58,999 cause-and-effect links
- Only links seen in at least two floods and two documents are released: 4,645 clear the bar; the tree keeps the 1,597 steps they connect
- We hand-checked 100 outputs first; 37 held a step the text did not support, and that error rate set the bar and is reported openly

::: {.notes}
About 60 seconds. Explain the picture first: three real links from the graph with their support counts, and the counts are distinct real-world floods, not documents, so one syndicated article cannot inflate them. The left pair is the strongest link in the whole graph and it is the Monmouth story again: roads, then access, then care. Then the construction in plain words. Many accounts describe the same step in different wording, so they are merged; each merged step is a node, and a link means one step was reported leading to another. The full graph holds everything; what we release is the subset of links with independent support, at least two floods and two documents, and drawing only those links naturally keeps only the steps they touch, which is why the tree is smaller than the graph. Close on the audit: before building, I hand-checked 100 machine outputs against their source text and 37 contained a step the text did not actually support. That number is in the method report, it is why the two-flood two-document bar exists, and reporting it openly is what makes the rest credible.
:::
